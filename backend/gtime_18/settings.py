"""
Django settings for gtime_18 project.
...
WSGI_APPLICATION = 'gtime_18.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gtime_18 API",
    "DESCRIPTION": "API documentation for gtime_18 App",
    "VERSION": "v1",
}
